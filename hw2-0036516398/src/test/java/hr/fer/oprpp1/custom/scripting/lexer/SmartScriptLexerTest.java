...
public class SmartScriptLexerTest {
    ...
    @Test
    public void testStringInsideTagComplex() {
        SmartScriptLexer lexer = new SmartScriptLexer("Tag {$ \"String is inside with \"another\" \"$}");
        lexer.nextToken();
        lexer.nextToken();
        assertEquals(TokenType.STRING, lexer.nextToken().getType());
        assertEquals("String is inside with \"another\" ", lexer.getCurrentToken().getValue().asText());
    }
